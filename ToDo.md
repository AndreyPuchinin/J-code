...
!  - доисправить, чтобы ошибка game_field: [[]] не выписывалась дважды одинаковая!

x  - дополнить функционал протягивания ошибки по всем файлам, по которым она пролегает 